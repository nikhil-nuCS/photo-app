...
class PostPublishComment extends React.Component {
    ...
    postComment() {
        ...
        fetch("https://photo-app-nk.herokuapp.com/api/comments", {
          method: "POST",
          headers: getHeaders(),
        ...
        return (
            <div class="post-user-comments">
                <div id="card-comment-feature">
                    ...
                    <input name={"comment-on-post-" + this.state.postid} aria-label="post a comment" class="post-comment" id={"post-comment-" + this.state.postid} type="text" placeholder="Add a comment ..." />
                </div>
